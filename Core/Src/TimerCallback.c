...
- Define timer instance some where in main or polling file. // TimerCallbackStruct timerInstanceMilliSeconds = {0}; // There is a default instance "timerCallback"
- Create a callback and pass timer instance and parameters. // TimerCallbackRegister(timerInstanceMilliSeconds, <function to callback>, 100, TIMER_REPEAT);
