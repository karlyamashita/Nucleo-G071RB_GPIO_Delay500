...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : PA10_Pin */
  GPIO_InitStruct.Pin = PA10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(PA10_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PB2_Pin PB15_Pin PB6_Pin */
  GPIO_InitStruct.Pin = PB2_Pin|PB15_Pin|PB6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : PB12_Pin */
